...
public class GridSystemVisual : MonoBehaviour
{
    ...
    [SerializeField] private List<GridVisualTypeMaterial> gridVisualTypeMaterialList = new List<GridVisualTypeMaterial>();
        ...
        for (int x = 0; x < LevelGrid.Instance.GetWidth(); x++)
        {
            for (int z = 0; z < LevelGrid.Instance.GetHeight(); z++)
            {
                ...
                Transform gridSystemVisualSingleTransform = Instantiate(
                    gridSystemVisualPrefab, LevelGrid.Instance.GetWorldPosition(gridPosition), Quaternion.identity);
    ...
    private Material GetGridVisualTypeMaterial(GridVisualType gridVisualType)
    {
        ...
        Debug.LogError("Can find grid visual type material for" + gridVisualType);
        return null;
    }
}
